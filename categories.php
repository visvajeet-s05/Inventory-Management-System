	...
	<div class="col-md-12">
		...
		<div class="content-card">
			<div class="content-card-header">
				<h3 class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Categories </h3>
			</div> <div class="remove-messages"></div>

			<div class="div-action pull pull-right" style="padding-bottom:20px;">
				<button class="btn btn-primary button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Categories </button>
			</div> <table class="table table-hover" id="manageCategoriesTable">
				<thead>
					<tr>							
			...
			</div> </div> </div> <div class="modal fade" id="addCategoriesModal" tabindex="-1" role="dialog">
