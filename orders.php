...
<h4 style="font-weight: 600; margin-bottom: 20px;">
	<i class='glyphicon glyphicon-circle-arrow-right' style="color: #007bff;"></i>
	<?php if($_GET['o'] == 'add') {
		echo "Add New Order";
	} else if($_GET['o'] == 'manord') { 
		echo "Manage Orders";
...
<div class="content-card">
	<div class="content-card-header" style="border-bottom: none; padding-bottom: 0; margin-bottom: 0;">

		<h3 class="page-heading" style="margin-bottom: 20px;">
			<?php if($_GET['o'] == 'add') { ?>
	...
	</div> <div class="remove-messages"></div> <?php if($_GET['o'] == 'add') { 
			// add order
			?>			

			<div class="success-messages"></div> <form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  </div> </div> <div class="form-group submitButtonFooter" style="clear:both;">
		...
		// /else manage order
			...
			<div class="success-messages"></div> <form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  </div> </div> <div class="form-group editButtonFooter" style="clear:both;">
			    <div class="col-sm-offset-2 col-sm-10">
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Add Row </button>
...
</div> <div class="modal fade" tabindex="-1" role="dialog" id="paymentOrderModal">
