	...
	<div class="col-md-12">
		...
		<div class="content-card">
			<div class="content-card-header">
				<h3 class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Brand </h3>
			</div> <div class="remove-messages"></div>

			<div class="div-action pull pull-right" style="padding-bottom:20px;">
				<button class="btn btn-primary button1" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add Brand </button>
			</div> <table class="table table-hover" id="manageBrandTable">
				<thead>
					<tr>							
						<th>Brand Name</th>
						<th>Status</th>
			...
			</div> </div> </div> <div class="modal fade" id="addBrandModel" tabindex="-1" role="dialog">
