	...
	<div class="col-md-12">
		...
		<div class="content-card">
			<div class="content-card-header">
				<h3 class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Manage Product </h3>
			</div> <div class="remove-messages"></div>

			<div class="div-action pull pull-right" style="padding-bottom:20px;">
				<button class="btn btn-primary button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add Product </button>
			</div> <table class="table table-hover" id="manageProductTable">
				<thead>
					<tr>
			...
			</div> </div> </div> <div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        </div> <div class="modal-footer editProductPhotoFooter">
				        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
			        ...
			        </div> <div class="modal-footer editProductFooter">
				        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close</button>
